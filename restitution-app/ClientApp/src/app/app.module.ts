...
@NgModule({ declarations: [
    ...
    bootstrap: [AppComponent], imports: [AppRoutingModule,
        ...
        TypeaheadModule.forRoot()], providers: [provideNgxMask(), JusticeApplicationDataService, LookupService, StateService, Title, provideHttpClient(withInterceptorsFromDi())] })
